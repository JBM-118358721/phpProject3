...
<head>
  ...
  <style>
    ...
    .tps-section:nth-child(1n+1) .tps-wrapper {
      background: url(thaiboxing.jpg) center center;
      background-size: cover;
    }
    
    .tps-section:nth-child(2n+1) .tps-wrapper {
      background:  url(bangkok.jpg) center center;
      background-size: cover;
    }
    
    .tps-section:nth-child(3n+1) .tps-wrapper {
      background:  url(deal.jpg) center center;
      background-size: cover;
    }
  ...
  <body>
      ...
      (function(){
	    ...
	    <div class="header">
        <h1>My Interests</h1>
        <h2>These range from sports to travel to consulting services</h2>
        <div class="btns">
            <a class="reload btn" href="index.php">Home.</a>
  	    </div>
  	  </div>
  	  <section class="page1">
        <div class="page_container">
          <h1><a  target="_blank">Muay Thai<br><small>A sport I always had an interest in but was too afraid to start until Janurary 2019</small></a></h1>
        </div>
      </section>
  	  <section class="page2">
        <div class="page_container">
          <h1><a  target="_blank">Travelled to Bangkok, Thailand<br><small>Completed at the end of a month long trip visiting family in 2014.</small></a></h1>
        </div>
      </section>
  	  <section class="page3">
        <div class="page_container">
          <h1><a  target="_blank">Consulting Services<br><small>As I am a BIS student this makes a competant business consultant</small></a></h1>
        </div>
      </section>
